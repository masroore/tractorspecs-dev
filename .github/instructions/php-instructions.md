# GitHub Copilot Custom Instructions for PHP 8.4/8.5 Projects

These instructions guide Copilot to generate modern, clean, secure, and maintainable PHP code for non-Laravel projects
using PHP 8.2 or newer. Follow strict standards, leverage language features, and produce production-quality software.
...
## ✅ PHP 8.4/8.5 Language Features to Use
...
- Always assume **strict typing** and modern PHP 8.4/8.5 usage.
